    ...
    <main>
      <article className="border">
        <div className="main-image-container">
          <img className="main-image" src="https://scrimba.com/links/travel-journal-australia-image-url"/>
        </div>
        <div>
          <p>
...
</svg> <span className="country-name">AUSTRALIA</span> <a className="google-link" href="http://">View on Google Maps</a>
          </p>
          
          <h1 className="title">Sydney Opera House</h1>
          <p className="date">27 May, 2023 - 8 Jun, 2023</p>
          <p className="copy">
